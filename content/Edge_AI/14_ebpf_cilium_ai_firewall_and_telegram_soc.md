...
> [!TIP]
> 🌐 **Language / 언어 선택**: **[🇰🇷 한국어 (현재 문서)](./14_ebpf_cilium_ai_firewall_and_telegram_soc.md)** | **[🇺🇸 Switch to English (영문 버전으로 전환)](./14_ebpf_cilium_ai_firewall_and_telegram_soc_EN.md)**
