...
kubectl apply -f /home/aiadmin01/web-dashboard/deployment.yaml
...
실행 방법:
```bash
chmod +x /home/aiadmin01/apply_all.sh
/home/aiadmin01/apply_all.sh
```
...
![Web Admin Dashboard UI Mockup](file:///home/aiadmin01/edge_ai_guide/images/web_dashboard.jpg)
...
- **실행**:
  ```bash
  python3 /home/aiadmin01/edge-ai-engine/test_all_features.py
  ```
...
- **실행**:
  ```bash
  python3 /home/aiadmin01/edge-ai-engine/test_token_logs.py
  ```
...
- **실행**:
  ```bash
  python3 /home/aiadmin01/edge-ai-engine/test_tts.py
  ```
